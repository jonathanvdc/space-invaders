...
die laatsten
\footnote{Inheritance-hi\"erarchie van \classname{Entity}: \url{Entity_inheritance.png} (in bijlage)}\footnote{Inheritance-hi\"erarchie van \classname{IController}: \url{Controller_inheritance.png} (in bijlage)}
